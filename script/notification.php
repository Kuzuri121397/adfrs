<?php
	...
	if($count > 0)
	{
		...
		while ($row=mysqli_fetch_array($result)) 
		{
			...
			echo "<div><a href='../pages/notification_list.php' style='color:black;'><center><b>See All</b></center></a></div>";
	}
	else
	{
		echo"<center>There are NO available notification(s)</center>";

		echo "<div><a href='../pages/notification_list.php'><center><b>See All</b></center></a></div>";
	}
