	...
	while ($row=mysqli_fetch_array($result)) 
	{
		...
		if (isset($_GET['inactive'])) 
		{
			...
			{	
				...
				$sql1="UPDATE t_user SET user_id='".$selectedUser."', user_status_id='2' WHERE user_id='".$selectedUser."'";
				...
				$activity=$fname.' '.$lname.' deactivated '.$selectedfname.' '.$selectedlname;
            	...
            	echo"<script>alert('The user is deactivated!'); window.location.href='../pages/manage_users.php?id=".$user."'</script>";
        	}
		}
	}
}
