			...
			if (isset($_POST['submit'])) 
			{
				...
				$particulars=$_POST['particulars'];
						...
						if(!empty($fileTmpName)) 
						{
							...
							if($numFile > 0)
							{
								echo"<script>alert('A file already exists!'); window.location.href='../pages/voucher.php?id=".$user_id."'</script>";
							}
							else
							{
								$folder="../system/files";
									...
									if ($fileError === 0) 
									{
										if($filesize < 1000000)
										{
            								...
            								move_uploaded_file($fileTmpName, $fileDestination);
            									...
            									echo"<script>alert('Updated Successfully!'); window.location.href='../pages/voucher.php?id=".$user_id."'</script>";
