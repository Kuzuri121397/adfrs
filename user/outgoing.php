                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body" style="width:50%;">
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-sm-5">
                                            <form action="../user_script/edit_outgoing.php" method="POST" class="form-horizontal" id="edit_outgoing_form"
                                             ...
                                             <div style="text-align: left;" class="caption">
                                                ...
                                                <p>
                                                 ...
                                                 <?php 
                                                  ...
                                                  <a class="btn btn-danger btn-sm" href="../user_script/delete_outgoing_file.php?file_delete=<?=$row['file_id']; ?>" data-toggle="tooltip" title="Delete" onclick="return confirm('This will delete the record permanently. Click OK to continue');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                                </p>
                                              </div>
                                            </div>
                            ...
                            <a class="btn btn-danger" href="../user_script/delete_outgoing.php?delete=<?=$row['outgoing_id']; ?>"onclick="return confirm('This will delete the record permanently. Click OK to continue');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    <?php
                      }
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../user_script/add_outgoing.php" method="POST" enctype="multipart/form-data" autocomplete="on" name="outgoing_form" onsubmit="return(validate());">
               <div class="form-group">
