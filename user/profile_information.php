...
<div class="row-offcanvas row-offcanvas-left">
  ...
  <ol class="breadcrumb" style="background-color:white;border-radius: 15px;">
      <li class="breadcrumb-item">
        <a href="../pages/home_user.php?user_id=<?=$row1['user_id'];?>" style="font-size:20px;"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
      </li>
                ...
                <div class="panel-body" style="height: 425px;">
                  <div class="container">
                    ...
                    <div id="UserProfile" class="tab-content">
                      <div class="container-fluid">
                        <form action="../user_script/update_profile.php" method="POST">
                    ...
                    <div id="ChangePassword" class="tab-content">
                      <div class="container-fluid">
                        <form action="../user/update_password.php" method="POST">
                          <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                          <div class="form-group row">
