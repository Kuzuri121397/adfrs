  ...
  <div class="container-fluid"><br>
    <div class="row placeholders">
      <div class="col-sm-offset-3 col-md-2 col-xs-6 col-sm-3 placeholder hvr-float">
        <a href="../pages/bill.php?user_id=<?=$row['user_id'];?>"><img src="../icon/bills.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
        <h4>Bills</h4>
      </div>  
      <div class="col-md-2 col-xs-6 col-sm-3 placeholder hvr-float">
        <a href="../pages/voucher.php?user_id=<?=$row['user_id'];?>"><img src="../icon/voucher.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
        <h4>Vouchers</h4>
      </div>
      <div class="col-md-2 col-xs-6 col-sm-3 placeholder hvr-float">
        <a href="../pages/incoming.php?user_id=<?=$row['user_id'];?>"><img src="../icon/inbox.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
        <h4>Incoming Communications</h4>
      </div>
      <div class="row placeholders">
        <div class="col-md-offset-4 col-md-2 col-xs-6 col-sm-3 placeholder hvr-float">
          <a href="../pages/outgoing.php?user_id=<?=$row['user_id'];?>"><img src="../icon/outbox.ico" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
          <h4>Outgoing Communications</h4>
        </div>
        <div class="col-md-2 col-xs-5 col-sm-3 placeholder hvr-float">
          <a href="../pages/dashboard.php?user_id=<?=$row['user_id'];?>"><img src="../icon/more.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
