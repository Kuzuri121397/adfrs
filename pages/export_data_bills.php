...
<div class="container-fluid">
  ...
  <ol class="breadcrumb" style="background-color:white; width:100%; border-radius: 15px;">
      ...
      <li class="breadcrumb-item active" style="font-size:20px; color:black;"><i class="fa fa-download" aria-hidden="true"></i> Export Data for Bills</li>
  </ol>
      <div class="col-md-12">
          <p class="visible-xs">
          ...
          <div class="row col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="btn-group">
                  <a href="../pages/export_data_bills.php?id=<?=$row['user_id'];?>" role="button" class="col-md-3 btn btn-danger">Bills</a>
                  <a href="../pages/export_data_vouchers.php?id=<?=$row['user_id'];?>" role="button" class="col-md-3 btn btn-primary">Vouchers</a>
                  <a href="../pages/export_data_incoming.php?id=<?=$row['user_id'];?>" role="button" class="btn btn-primary">Incoming Communications</a>
