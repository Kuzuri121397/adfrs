    ...
    <div class="row placeholders">  
        <div class="panel panel-default">
              <div class="panel-heading" style="text-align: left;">
                <b>Your Notifications</b><span class="pull-right"><b>Go <a href="../pages/dashboard.php?user_id=<?=$row['user_id'];?>" style="text-decoration: none; color:blue;">Back to dashboard</a><b></span>
              </div>
