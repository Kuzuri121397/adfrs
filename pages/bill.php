                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body" style="width:50%;">
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-sm-5">
                                            <form action="../script/edit_bill.php" method="POST" class="form-horizontal" id="edit_bill_form"
                                            enctype="multipart/form-data">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                  <input type="date" min="2010-01-01" max="<?=date('Y-m-d');?>" class="form-control" name="date_receive" id="date_receive" placeholder="Date Recieved" required value="<?php echo $date_receive; ?>" onkeydown="return false">
                                                </div>
                                              </div>
                                              <div class="form-group">
                                                <label class="control-label col-sm-3" for="due_date"><h6><b>Due Date:</b></h6></label>
                                                <div class="col-sm-6">
                                                  <input type="date" min="2010-01-01" class="form-control" name="due_date" id="due_date" placeholder="Due Date" required value="<?php echo $due_date; ?>" onkeydown="return false">
                                                </div>
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                  <input type="number" class="form-control" name="receipt_no" id="receipt_no" onkeyup="myStatus()" placeholder="Receipt No." value="<?php echo $receipt_no; ?>">
                                                </div>
                                              </div>

                                              <div class="form-group">
                                                <label class="control-label col-sm-3"><h6><b>Status:<b></h6></label>
                                                <div class="col-sm-6">
                                                  <input readonly type="text" class="form-control" name="status" id="status" value="<?php echo $stat_table; ?>">
                                                </div>
                                              </div>
                                              ...
                                              <!--div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                  <select name="status" class="form-control " id="status">
                                                    <option value="" selected disabled><?php echo $stat_table; ?></option>
                                             ...
                                             <div style="text-align: left;" class="caption">
                                                ...
                                                <p>
                                                 ...
                                                 <?php 
                                                  ...
                                                  ?>
                                                  <a class="btn btn-danger btn-sm" href="../script/delete_bill_file.php?file_delete=<?=$row['file_id']; ?>" data-toggle="tooltip" title="Delete" onclick="return confirm('This will delete the record permanently. Click OK to continue');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                                </p>
                                              </div>
                                            </div>
                            ...
                            <a class="btn btn-danger" href="../script/delete_bill.php?delete=<?=$row['bill_id']; ?>"onclick="return confirm('This will delete the record permanently. Click OK to continue');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    <?php
                      }
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div id="error_msg" style="color: red; text-align: center; margin:10px auto;"></div>
            <form action="../script/add_bill.php" method="POST" enctype="multipart/form-data" autocomplete="on" name="bill_form" onsubmit="return(validate());">
               <div class="form-group">
                  <label for="payee">Payee:</label>
                  <input type="text" class="form-control" name="payee" id="payee">
                  <!--select class="js-example-basic-single form-control" name="payee" id="payee" style="width: 100%;">
                    <option></option>
                    <option value="Leyeco">Leyeco</option>
                    <option value="LMWD">LMWD</option>
              ...
              <div class="form-group">
                  ...
                  <input type="date" min="2010-01-01" max="<?=date('Y-m-d');?>"  class="form-control" name="date_receive" id="received" value="<?=date('Y-m-d');?>" onkeydown="return false" required>
                </div>
                <div class="form-group">
                  <label for="due_date">Due Date&nbsp;<span style="color:red;">(day-month-year)</span></label>
                  <input type="date" min="<?=date('Y-m-d');?>" max="<?= date('Y')?>" class="form-control" name="due_date" placeholder="Due Date" id="due" onkeydown="return false" required>
                </div>
                <div class="form-group">
                  <label for="rec">Receipt No.</label>
                  <input type="number" class="form-control" name="receipt_no" id="rec" onkeyup="stat()" placeholder="Receipt No.">
                </div>
                <div>
                <div class="form-group">
                  <label for="stat">Status</label>
                  <input readonly type="text" class="form-control" name="status" id="statusBill" value="Unpaid">
...
<!--script>
  $(document).ready(function() {
    ...
    // Set the value, creating a new option if necessary
                    if ($('#payee').find("option[value='" + data.id + "']").length) 
                    {
                      $('#payee').val(data.id).trigger('change');
                    } 
                    else 
                    { 
  ...
  function stat()
{
  ...
  {
    document.getElementById("statusBill").value='Paid';
  }
  else
  {
    document.getElementById("statusBill").value='Unpaid';
  }
}
</script>
